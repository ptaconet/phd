    ...
    fun_workflow_model <- function(response_var, 
      ...
      if(period_interv!="all"){
        th_trmetrics_entomo_postedecapture <- th_trmetrics_entomo_postedecapture %>% dplyr::filter(period_interv==period_interv)
      }
    ...
    if(mod %in% c("physiological_resistance_kdrw","physiological_resistance_kdre","physiological_resistance_ace1","exophagy")){
      ...
      ### selection of predictors
       if (mod %in% c("exophagy")){
          ...
          predictors <- c("NMTI","NMHI","NMLE","NMA","DNMT","DNMH","DNML","WSP","RFH","VCM","VCT2","HBB","HBI","LUS","LMN","RFD1F_2000_0_30","TMAX1_2000_0_30","TMAX1_2000_0_0","RFD1F_2000_0_0","BDE","WMD")  # predictors = same as dayscience + some landscape and meteorological variables + physiological resistances
          ...
          predictors <- c("VCM","VCT2","HBB2","HBI2","LUS","RFD1F_2000_0_30","TMAX1_2000_0_30","TMAX1_2000_0_0","RFD1F_2000_0_0","BDE","WMD","int_ext") 
          ...
          glmm_varstoforce <- NULL
          predictors <-c(lsm_agri,"VCM","VCT2","LUS","int_ext","HBB","HBI")
          
          if(code_pays=="BF"){
            predictors <- c(predictors,"VCT")
          }
      ...
      # multicollinearity among predictors
        ...
        pvals_filt_int_elb <- glmms_univs %>% filter(p.value <= 0.2, grepl("ELB",term))
        if(nrow(pvals_filt_int_elb)>0){
          predictors <- c(predictors, "ELB")
          pvals_filts <- rbind(pvals_filts, pvals_filt_int_elb)
        }
    ...
    df_input_params_glmm <- df_input_params_glmm %>%
      ...
      add_row(response_var = "ma_funestus_ss", code_pays = "BF", mod = "exophagy", period_interv="post_intervention") %>%
      add_row(response_var = "ma_gambiae_ss", code_pays = "BF", mod = "exophagy", period_interv="post_intervention") %>%
      add_row(response_var = "ma_coluzzi", code_pays = "BF", mod = "exophagy", period_interv="post_intervention") %>%
      add_row(response_var = "ma_funestus_ss", code_pays = "BF", mod = "early_biting", period_interv="post_intervention") %>%
      add_row(response_var = "ma_gambiae_ss", code_pays = "BF", mod = "early_biting", period_interv="post_intervention") %>%
      add_row(response_var = "ma_coluzzi", code_pays = "BF", mod = "early_biting", period_interv="post_intervention")%>%
      add_row(response_var = "ma_funestus_ss", code_pays = "BF", mod = "late_biting", period_interv="post_intervention") %>%
      add_row(response_var = "ma_gambiae_ss", code_pays = "BF", mod = "late_biting", period_interv="post_intervention") %>%
      add_row(response_var = "ma_coluzzi", code_pays = "BF", mod = "late_biting", period_interv="post_intervention")  %>%
      add_row(response_var = "ma_gambiae_ss", code_pays = "BF", mod = "physiological_resistance_kdrw", period_interv = "post_intervention") %>%
      add_row(response_var = "ma_coluzzi", code_pays = "BF", mod = "physiological_resistance_kdrw", period_interv = "post_intervention") %>%
      add_row(response_var = "ma_gambiae_ss", code_pays = "BF", mod = "physiological_resistance_kdre", period_interv = "post_intervention") %>%
      add_row(response_var = "ma_coluzzi", code_pays = "BF", mod = "physiological_resistance_kdre", period_interv = "post_intervention") %>%
      add_row(response_var = "ma_gambiae_ss", code_pays = "BF", mod = "physiological_resistance_ace1", period_interv = "post_intervention") %>%
      add_row(response_var = "ma_coluzzi", code_pays = "BF", mod = "physiological_resistance_ace1", period_interv = "post_intervention") %>%
      add_row(response_var = "ma_funestus_ss", code_pays = "CI", mod = "exophagy", period_interv = "all") %>%
      add_row(response_var = "ma_gambiae_sl", code_pays = "CI", mod = "exophagy", period_interv = "all") %>%
      add_row(response_var = "ma_funestus_ss", code_pays = "CI", mod = "early_biting", period_interv = "all") %>%
      add_row(response_var = "ma_gambiae_sl", code_pays = "CI", mod = "early_biting", period_interv = "all") %>%
      add_row(response_var = "ma_funestus_ss", code_pays = "CI", mod = "late_biting", period_interv = "all") %>%
      add_row(response_var = "ma_gambiae_sl", code_pays = "CI", mod = "late_biting", period_interv = "all") %>%
      add_row(response_var = "ma_funestus_ss", code_pays = "CI", mod = "exophagy", period_interv = "post_intervention") %>%
      add_row(response_var = "ma_gambiae_sl", code_pays = "CI", mod = "exophagy", period_interv = "post_intervention") %>%
      add_row(response_var = "ma_funestus_ss", code_pays = "CI", mod = "early_biting", period_interv = "post_intervention") %>%
      add_row(response_var = "ma_gambiae_sl", code_pays = "CI", mod = "early_biting", period_interv = "post_intervention") %>%
      add_row(response_var = "ma_funestus_ss", code_pays = "CI", mod = "late_biting", period_interv = "post_intervention") %>%
      add_row(response_var = "ma_gambiae_sl", code_pays = "CI", mod = "late_biting", period_interv = "post_intervention")
      ...
      th_model_results1 <- df_input_params_glmm[1,] %>%
        mutate(results = pmap(list(response_var, code_pays, mod,period_interv), ~fun_workflow_model(..1,..2,..3,..4)))
            ...
            th_model_results16 <- df_input_params_glmm[16,] %>%
              ...
              th_model_results31 <- df_input_params_glmm[31,] %>%
                mutate(results = pmap(list(response_var, code_pays, mod,period_interv), ~fun_workflow_model(..1,..2,..3,..4)))
              th_model_results32 <- df_input_params_glmm[32,] %>%
                mutate(results = pmap(list(response_var, code_pays, mod,period_interv), ~fun_workflow_model(..1,..2,..3,..4)))
              th_model_results33 <- df_input_params_glmm[33,] %>%
                mutate(results = pmap(list(response_var, code_pays, mod,period_interv), ~fun_workflow_model(..1,..2,..3,..4)))
              th_model_results34 <- df_input_params_glmm[34,] %>%
                mutate(results = pmap(list(response_var, code_pays, mod,period_interv), ~fun_workflow_model(..1,..2,..3,..4)))
              th_model_results35 <- df_input_params_glmm[35,] %>%
                mutate(results = pmap(list(response_var, code_pays, mod,period_interv), ~fun_workflow_model(..1,..2,..3,..4)))
              th_model_results36 <- df_input_params_glmm[36,] %>%
                mutate(results = pmap(list(response_var, code_pays, mod,period_interv), ~fun_workflow_model(..1,..2,..3,..4)))
              th_model_results37 <- df_input_params_glmm[37,] %>%
                mutate(results = pmap(list(response_var, code_pays, mod,period_interv), ~fun_workflow_model(..1,..2,..3,..4)))
              th_model_results38 <- df_input_params_glmm[38,] %>%
                mutate(results = pmap(list(response_var, code_pays, mod,period_interv), ~fun_workflow_model(..1,..2,..3,..4)))
              th_model_results39 <- df_input_params_glmm[39,] %>%
                mutate(results = pmap(list(response_var, code_pays, mod,period_interv), ~fun_workflow_model(..1,..2,..3,..4)))
              th_model_results40 <- df_input_params_glmm[40,] %>%
                mutate(results = pmap(list(response_var, code_pays, mod,period_interv), ~fun_workflow_model(..1,..2,..3,..4)))
              th_model_results41 <- df_input_params_glmm[41,] %>%
                mutate(results = pmap(list(response_var, code_pays, mod,period_interv), ~fun_workflow_model(..1,..2,..3,..4)))
              th_model_results41 <- df_input_params_glmm[42,] %>%
                mutate(results = pmap(list(response_var, code_pays, mod,period_interv), ~fun_workflow_model(..1,..2,..3,..4)))
