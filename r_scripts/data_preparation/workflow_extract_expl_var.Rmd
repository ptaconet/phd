...
write.csv(TMAX7, file.path("data",roi_name,"TMAX8.csv"), row.names = F)
write.csv(TMIN7, file.path("data",roi_name,"TMIN8.csv"), row.names = F)
write.csv(TAMP7, file.path("data",roi_name,"TAMP8.csv"), row.names = F)
```
